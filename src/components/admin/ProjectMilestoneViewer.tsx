...
const ProjectMilestoneViewer = () => {
  ...
  const fetchAllProjects = async () => {
    setLoading(true);
    try {
      const result = await projectWorkflowService.getAllProjects();
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">View and manage project milestones across all projects</p>
        </div>
        <Button 
...
export default ProjectMilestoneViewer;
